...
/**
 * The data field's display state machine: maps [PartnerGapState] plus a monotonic "now" to what
...
object FieldState {
    ...
    fun build(state: PartnerGapState, nowElapsedMs: Long): FieldDisplay {
